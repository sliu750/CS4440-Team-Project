...
byIndustry = glob.glob("Data\Final CSV Files\By Industry\*.csv")
print(byIndustry)
df = pd.concat((pd.read_csv(f, usecols=["Characteristic", "fatal_injury_rate"]) for f in byIndustry), ignore_index=True)
